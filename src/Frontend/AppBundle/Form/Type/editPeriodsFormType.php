...
class editPeriodsFormType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('startDate', 'date', array('format' => 'MM/dd/yyyy','widget'=>'single_text','label'=>'Start Date','attr' => array('class' => 'form-control period-calendar'),'required' => false))
            ->add('endDate', 'date', array('format' => 'MM/dd/yyyy','widget'=>'single_text','label'=>'End Date','attr' => array('class' => 'form-control period-calendar'),'required' => false))
            ...
            ->add('nightly', null, array('validation_groups' => array('propertyPeriod'),'label'=>'Per Night','attr' => array('class' => 'form-control'),'required' => false))    
