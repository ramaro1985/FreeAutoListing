...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/opt/lampp/htdocs/FreeAutoListing/app/cache/dev/annotations', true);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Frontend\AppBundle\Form\Type\ChangePasswordFormType A Frontend\AppBundle\Form\Type\ChangePasswordFormType instance.
     */
    ...
    /**
     * Gets the 'app_user_registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Frontend\AppBundle\Form\Type\RegistrationFormType A Frontend\AppBundle\Form\Type\RegistrationFormType instance.
     */
    ...
    /**
     * Gets the 'app_user_resetting.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Frontend\AppBundle\Form\Type\ResettingFormType A Frontend\AppBundle\Form\Type\ResettingFormType instance.
     */
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'freeautolisting', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_8fc24887981acf70db47760ed8633644b092faf76bbfc623d31518d42f0b6d11');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_8fc24887981acf70db47760ed8633644b092faf76bbfc623d31518d42f0b6d11');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_8fc24887981acf70db47760ed8633644b092faf76bbfc623d31518d42f0b6d11');
        ...
        $f->setProxyDir('/opt/lampp/htdocs/FreeAutoListing/app/cache/dev/doctrine/orm/Proxies');
    ...
    /**
     * Gets the 'isometriks_spam.form.extension.provider.timed_spam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Isometriks\Bundle\SpamBundle\Form\Extension\Spam\Provider\SessionTimedSpamProvider A Isometriks\Bundle\SpamBundle\Form\Extension\Spam\Provider\SessionTimedSpamProvider instance.
     */
    ...
    /**
     * Gets the 'isometriks_spam.form.extension.type.honeypot' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Isometriks\Bundle\SpamBundle\Form\Extension\Spam\Type\FormTypeHoneypotExtension A Isometriks\Bundle\SpamBundle\Form\Extension\Spam\Type\FormTypeHoneypotExtension instance.
     */
    ...
    /**
     * Gets the 'isometriks_spam.form.extension.type.timed_spam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Isometriks\Bundle\SpamBundle\Form\Extension\Spam\Type\FormTypeTimedSpamExtension A Isometriks\Bundle\SpamBundle\Form\Extension\Spam\Type\FormTypeTimedSpamExtension instance.
     */
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/opt/lampp/htdocs/FreeAutoListing/app/logs/dev.log', 100, true);
    }
    ...
    /**
     * Gets the 'my.sitemap.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Frontend\AppBundle\EventListener\SitemapListener A Frontend\AppBundle\EventListener\SitemapListener instance.
     */
     ...
     * This method always returns the same instance of the service.
     *
     * @return Backend\AdminBundle\Controller\FOSUBUserProvider A Backend\AdminBundle\Controller\FOSUBUserProvider instance.
     */
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/opt/lampp/htdocs/FreeAutoListing/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b), 'main', $c, $d), 2 => $j, 3 => $l, 4 => $n, 5 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $i, $g, $c, $d), 6 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57dd67e06b767', $c), 7 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'main', new \HWI\Bundle\OAuthBundle\Security\Http\EntryPoint\OAuthEntryPoint($e, '/login'), NULL, NULL, $c));
    }

    /**
     * Gets the 'security.firewall.map.context.support' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/opt/lampp/htdocs/FreeAutoListing/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/opt/lampp/htdocs/FreeAutoListing/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/opt/lampp/htdocs/FreeAutoListing/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/opt/lampp/htdocs/FreeAutoListing/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'AppBundle', 1 => 'CommonBundle'), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/opt/lampp/htdocs/FreeAutoListing/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/opt/lampp/htdocs/FreeAutoListing/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
     ...
     * This method always returns the same instance of the service.
     *
     * @return Frontend\AppBundle\EventListener\EmailConfirmationListener A Frontend\AppBundle\EventListener\EmailConfirmationListener instance.
     */
     ...
     * This method always returns the same instance of the service.
     *
     * @return Frontend\AppBundle\Form\Type\ResendConfirmFormType A Frontend\AppBundle\Form\Type\ResendConfirmFormType instance.
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/opt/lampp/htdocs/FreeAutoListing/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/opt/lampp/htdocs/FreeAutoListing/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/opt/lampp/htdocs/FreeAutoListing/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/opt/lampp/htdocs/FreeAutoListing/app/cache/dev',
            ...
            'debug.container.dump' => '/opt/lampp/htdocs/FreeAutoListing/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/opt/lampp/htdocs/FreeAutoListing/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/opt/lampp/htdocs/FreeAutoListing/app/cache/dev/profiler',
            ...
            'router.resource' => '/opt/lampp/htdocs/FreeAutoListing/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/opt/lampp/htdocs/FreeAutoListing/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/opt/lampp/htdocs/FreeAutoListing/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/opt/lampp/htdocs/FreeAutoListing/app/cache/dev/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/opt/lampp/htdocs/FreeAutoListing/app/cache/dev/doctrine/orm/Proxies',
            ...
            'white_october_tcpdf.tcpdf' => array(
                ...
                'k_path_cache' => '/opt/lampp/htdocs/FreeAutoListing/app/cache/dev/tcpdf',
                'k_path_url_cache' => '/opt/lampp/htdocs/FreeAutoListing/app/cache/dev/tcpdf',
