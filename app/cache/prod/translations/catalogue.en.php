...
$catalogue = new MessageCatalogue('en', array (
  ...
  array (
    ...
    'app_registration.name.blank' => 'Please enter your First Name',
    'app_registration.name.short' => '[-Inf,Inf]The name is too short',
    'app_registration.name.long' => '[-Inf,Inf]The name is too long',
    'app_registration.lastname.blank' => 'Please enter your Last Name',
    'app_registration.lastname.short' => '[-Inf,Inf]The name is too short',
    'app_registration.lastname.long' => '[-Inf,Inf]The name is too long',
    'app_registration.email.already_used' => 'The email is already used',
    'app_registration.email.blank' => 'Please enter an email',
    'app_registration.email.short' => '[-Inf,Inf]The email is too short',
    'app_registration.email.long' => '[-Inf,Inf]The email is too long',
    'app_registration.email.invalid' => 'The email is not valid',
    'app_registration.password.blank' => 'Please enter a password',
    'app_registration.password.short' => '[-Inf,Inf]The password is too short',
    'app_registration.password.mismatch' => 'The entered passwords don\'t match',
    'app_registration.new_password.blank' => 'Please enter a new password',
    'app_registration.new_password.short' => '[-Inf,Inf]The new password is too short',
    'app_registration.current_password.invalid' => 'The entered password is invalid',
    'app_registration.group.blank' => 'Please enter a name',
    'app_registration.group.short' => '[-Inf,Inf]The name is too short',
    'app_registration.group.long' => '[-Inf,Inf]The name is too long',
    'app_registration.phone.blank' => 'Please enter your Phone number',
    'app_registration.phone.short' => '[-Inf,Inf]The phone number is too short',
    'app_registration.phone.long' => '[-Inf,Inf]The phone number is too long',
...
',
  ...
  array (
    ...
    'change_password.submit' => 'Change password',
    'change_password.flash.success' => 'The password has been changed',
    'registration.check_email' => 'An email has been sent to %email% with a link to activate your account.',
    'registration.confirmed' => 'Congrats %username%, your account is now activated.',
    'registration.back' => 'Back to the originating page.',
    'registration.submit' => 'Register',
    'registration.flash.user_created' => 'Thank you for registering with Free Auto Listing',
    'registration.email.subject' => 'Welcome %username%!',
    'registration.email.message' => 'Hello %username%!
