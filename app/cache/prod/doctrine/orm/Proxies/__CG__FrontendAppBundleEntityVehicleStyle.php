 ...
 */
class VehicleStyle extends \Frontend\AppBundle\Entity\VehicleStyle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'vehiclesinformation');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VehicleStyle $proxy) {
