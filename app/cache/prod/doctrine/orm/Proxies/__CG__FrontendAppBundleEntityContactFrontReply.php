 ...
 */
class ContactFrontReply extends \Frontend\AppBundle\Entity\ContactFrontReply implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'contact', 'user', 'text', 'dateCreated');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ContactFrontReply $proxy) {
