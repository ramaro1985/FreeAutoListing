 ...
 */
class UserRequest extends \Frontend\AppBundle\Entity\UserRequest implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'profile', 'status', 'dateCreated', 'text', 'user');
        }
