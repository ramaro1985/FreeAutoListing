 ...
 */
class ContactOwner extends \Frontend\AppBundle\Entity\ContactOwner implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'user', 'replied', 'dateCreated', 'status', 'serie', 'text', 'recaptcha', 'replys');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ContactOwner $proxy) {
