 ...
 */
class ContactInvestor extends \Frontend\AppBundle\Entity\ContactInvestor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'lastName', 'email', 'dateCreated', 'status', 'phone', 'serie', 'text', 'replied', 'recaptcha');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ContactInvestor $proxy) {
    ...
    public function getReplied()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getReplied', array());
