 ...
 */
class Year extends \Frontend\AppBundle\Entity\Year implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'year', 'makes', 'vehiclesinformation');
        }
    ...
    public function getMakes()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMakes', array());

        return parent::getMakes();
    }
