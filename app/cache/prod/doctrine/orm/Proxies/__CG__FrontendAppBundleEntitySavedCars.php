 ...
 */
class SavedCars extends \Frontend\AppBundle\Entity\SavedCars implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'notes', 'user', 'vehicle');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SavedCars $proxy) {
