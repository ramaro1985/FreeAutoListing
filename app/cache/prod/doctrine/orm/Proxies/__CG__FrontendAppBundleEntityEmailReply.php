 ...
 */
class EmailReply extends \Frontend\AppBundle\Entity\EmailReply implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'email', 'text', 'dateCreated');
        }
