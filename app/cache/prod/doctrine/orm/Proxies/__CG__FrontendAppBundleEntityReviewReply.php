 ...
 */
class ReviewReply extends \Frontend\AppBundle\Entity\ReviewReply implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'review', 'text', 'dateCreated');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ReviewReply $proxy) {
