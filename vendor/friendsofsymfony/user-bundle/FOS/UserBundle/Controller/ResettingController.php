...
class ResettingController extends ContainerAware
{
    ...
    public function sendEmailAction(Request $request)
    {
     ...
     public function sendEmailResetting($user) {
        ...
        ->setFrom('registration@homeescape.com','Homeescape')
        ->setTo($user->getEmail())
        ->setBody($this->container->get('templating')->renderResponse('AppBundle:Default:password-resetting-mail.html.twig', array(
            'user'=>$user,
            'url'=>$url
