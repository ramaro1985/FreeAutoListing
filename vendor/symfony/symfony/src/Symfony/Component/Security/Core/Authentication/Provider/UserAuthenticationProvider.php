    ...
    public function authenticate(TokenInterface $token)
    {
        ...
        try {
            ...
            if ($this->hideUserNotFoundExceptions) {
                throw new BadCredentialsException('It looks like that email/password combination does not match our records. Please try again.', 0, $notFound);
            }
        ...
        try {
            ...
            if ($this->hideUserNotFoundExceptions) {
                throw new BadCredentialsException('It looks like that email/password combination does not match our records. Please try again.', 0, $e);
            }
